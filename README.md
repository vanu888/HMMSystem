...
2. Clone this repository:
   ```bash
   git clone https://github.com/vihanga-anuththara/HMMSystem.git
   cd HMMSystem
   ```

## User Manual

For detailed instructions on using this project, please refer to the [User Manual](https://vihanga-anuththara.github.io/HMMSystem/#chapter1).
Alternatively, you can visit the user manual directly at:  
[https://vihanga-anuththara.github.io/HMMSystem/#chapter1](https://vihanga-anuththara.github.io/HMMSystem/#chapter1)
