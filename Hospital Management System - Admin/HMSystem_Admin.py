...
welcome = resource_path('icons/welcome.png')
logo_jpg = resource_path('icons/logo.jpg')
login = resource_path('icons/login.jpg')
pdf = resource_path('icons/pdf.png')
...
class HospitalManagementAdminApp:
    ...
    def show_welcome_screen(self):
        ...
        # Show Intro details
        Intro_label = ttk.Label(self.welcome_window, text="Hospital Management System - Admin", background="#f0f0f0", font=("Arial",14, "bold"))
        Intro_label.pack(pady=20)
        
        # Load and display an image
        self.welcome_image = Image.open(welcome)  
        self.welcome_image = self.welcome_image.resize((400, 300), Image.LANCZOS)  # Resize image
        self.welcome_photo = ImageTk.PhotoImage(self.welcome_image)
        welcome_label_image = tk.Label(self.welcome_window, image=self.welcome_photo, background="#f0f0f0")
        welcome_label_image.pack(pady=10)

        # Create a loading bar
        self.loading_bar = ttk.Progressbar(self.welcome_window, orient="horizontal", length=400, mode="indeterminate")
    ...
    def create_login_tab(self):
        ...
        self.login_image = self.login_image.resize((200, 200), Image.LANCZOS)  # Resize image
        self.login_photo = ImageTk.PhotoImage(self.login_image)
        login_label_image = tk.Label(self.login_frame, image=self.login_photo, background="#f0f0f0")
    ...
    def create_display_tab(self):
        ...
        self.export_button = ttk.Button(self.display_frame, text="Export All Data to PDF", image=self.pdf_photo, compound="left", command=self.export_all_data_to_pdf)
    ...
    def export_all_data_to_pdf(self):
        ...
        pdf_file_name = "Patients_data_by_HMSystem_Admin.pdf" # Set file name to the pdf file
    ...
    def create_about_tab(self):
        ...
        # About section data
        about_label = ttk.Label(self.about_frame, text="Hospital Management System - Admin\nDeveloped by: Vihanga Anuththara \nFollow me on Github: vanu888 \npower to FOSS :)")
        about_label.pack(pady=20)
        
        # Display an image
        self.about_image = Image.open(welcome)  
        self.about_image = self.about_image.resize((400, 300), Image.LANCZOS)  # Resize image
        self.about_photo = ImageTk.PhotoImage(self.about_image)
        about_label_image = tk.Label(self.about_frame, image=self.about_photo, background="#f0f0f0")
        about_label_image.pack(pady=10)
        
        # Create a button to opens the user manual link
        user_manual_button = tk.Button(self.about_frame, text="User Manual", command=open_user_manual)
