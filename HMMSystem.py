...
class HospitalMedicineManagementApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Hospital Medicine Management System")
    ...
    def lock_tabs(self):
        for i in range(1, 5):  # Disable all tabs except the first (login)
            self.notebook.tab(i, state='disabled')

    def unlock_tabs(self):
        for i in range(1, 5):  # Enable all tabs except the first (login)
    ...
    #Function for Issue medications tab -- 24.09.2024 (Bosco sir)
    ...
    def issue_medications(self):
        ...
        if med_id in medications and quantity_to_issue.isdigit():
            ...
            if quantity_to_issue > current_quantity:
                ...
                medications[med_id]['quantity'] -= quantity_to_issue
            ...
            messagebox.showerror("Error","Invalid medication ID or quantity")
    ...
    def export_all_data_to_pdf(self):
        ...
        pdf_file_name = "Medcines data by HMMSystem.pdf"
